...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.label_7.setGeometry(QtCore.QRect(30, 410, 281, 31))
        self.label_7.setStyleSheet("color:rgb(255, 0, 0);\n"
"font: 75 16pt \"MS Shell Dlg 2\";")
        self.label_7.setObjectName("label_7")
        self.pushButton_4 = QtWidgets.QPushButton(Form)
        self.pushButton_4.setGeometry(QtCore.QRect(30, 450, 271, 41))
...
if __name__ == "__main__":
    ...
    Form = QtWidgets.QMainWindow()  # قم بتغيير هذا السطر
    ui = Ui_Form1()
    ui.setupUi(Form)
    Form.show()
    sys.exit(app.exec_())
