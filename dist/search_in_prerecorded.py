...
class FaceRecognition:
                ...
                if self.process_current_frame:
                    if frame_count % 5 == 0:  
                        ...
                        for face_location, face_encoding in zip(self.face_locations, self.face_encodings):
                            ...
                            min_face_height_threshold = 0.1  # Adjust this value as needed
                            min_face_width_threshold = 0.1  # Adjust this value as needed
    ...
    @staticmethod
    def face_confidence(face_distance, face_match_threshold=0.01):
